...
function gitPrompt { command -v __git_ps1 > /dev/null && __git_ps1 " (%s)"
}
...
export PS1="\n${nameC}\u${atC}@${hostC}\h:${pathC}\W${gitC}\$(gitPrompt)${pointerC} ▶${normalC} "
export PS1="\n${nameC}\u${atC}@${hostC}\h:${pathC}\W${gitC}\$(gitPrompt)${pointerC}$ ${normalC} "

#export PS1="\033[01;32m\]\u@\h:\W\[\033[01;31m\]\$(parse_git_branch)\[\033[01;00m\] $ "
#export PS1="\n\033[01;92m\][*]\[\033[01;36m\] \W\[\033[01;00m\] $ \[\033[01;00m\]"
#export PS1="\[\033[01;31m\]\u\[\033[01;31m\]@\[\033[01;31m\]\h\[\033[01;31m\]\w\$[\033[01;34m\]\n>>\[\033[01;00m\] "
